...
$root_path = $_SERVER['DOCUMENT_ROOT'] . '/'; // Adjust if your project is in a subdirectory
$base_url = (isset($_SERVER['HTTPS']) ? 'https://' : 'http://') . $_SERVER['HTTP_HOST'] . '/'; // Adjust if your project is in a subdirectory

// Include database connection
include($root_path . "server/connection.php");
...
<body>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="cartDrawer">
        ...
        <div class="offcanvas-footer cart-footer p-3">
            ...
            <div class="mt-3">
                <a href="<?php echo $base_url; ?>cart.php" class="btn btn-outline-primary w-100">View Cart</a>
                <a href="<?php echo $base_url; ?>checkout.php" class="btn btn-success w-100 mt-2">Checkout</a>
            </div>
        </div>
    </div>
    ...
    <header class="navbar navbar-expand-lg bg-light shadow-sm sticky-header">
        <div class="container-fluid">
            ...
            <a class="navbar-brand" href="<?php echo $base_url; ?>index.php">
                <img src="<?php echo $base_url; ?>images/logo.webp" alt="Shady Shades Logo" style="height: 50px;">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link <?= basename($_SERVER['PHP_SELF']) == 'products.php' ? 'active' : '' ?>" href="<?php echo $base_url; ?>products.php">Shop All</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?= basename($_SERVER['PHP_SELF']) == 'prescription-frames.php' ? 'active' : '' ?>" href="<?php echo $base_url; ?>prescription-frames.php">Prescription Frames</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?= basename($_SERVER['PHP_SELF']) == 'index.php' ? 'active' : '' ?>" href="<?php echo $base_url; ?>index.php">🔥Sale🔥</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?= basename($_SERVER['PHP_SELF']) == 'doctors.php' ? 'active' : '' ?>" href="<?php echo $base_url; ?>doctors.php">Doctors</a>
                    </li>

                    <?php if (isset($_SESSION["user_id"]) && $user_type === 'doctor'): ?>
                        <li class="nav-item">
                            <a class="nav-link <?= basename($_SERVER['PHP_SELF']) == 'doctor_dashboard.php' ? 'active' : '' ?>" href="<?php echo $base_url; ?>doctor_dashboard.php">Dashboard</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?= basename($_SERVER['PHP_SELF']) == 'doctor_appointments.php' ? 'active' : '' ?>" href="<?php echo $base_url; ?>doctor_appointments.php">Appointments</a>
                        </li>
                    <?php endif; ?>
                </ul>
                ...
                <div class="d-flex align-items-center">
                    ...
                    <?php else: ?>
                        ...
                        <a href="<?php echo $base_url; ?>profile.php" class="btn btn-outline-secondary me-2">
                        ...
                        <?php elseif ($user_type === 'doctor'): ?>
                            <!-- Doctor Appointments -->
                            <a href="<?php echo $base_url; ?>doctor_appointments.php" class="icon-container me-2">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="loginForm" action="<?php echo $base_url; ?>server/login_process.php" method="POST">
                        <input type="email" name="email" class="form-control mb-3" placeholder="Email" required>
                        <input type="password" name="password" class="form-control mb-3" placeholder="Password" required>
                        <button type="submit" class="btn btn-primary w-100">Log In</button>
                    </form>
                    <div class="text-center mt-3">
                        <a href="<?php echo $base_url; ?>otp/forgot_password.php" class="text-decoration-none">Forgot Password?</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" id="signupModal" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="signupForm" action="<?php echo $base_url; ?>server/signup_process.php" method="POST">
    ...
    <div class="modal fade" id="doctorLoginModal" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="doctorLoginForm" action="<?php echo $base_url; ?>server/doctor_login.php" method="POST">
    ...
    <script>
        ...
        function updateCart() {
            $.ajax({
                url: "<?php echo $base_url; ?>server/fetch_cart.php",
                method: "GET",
                dataType: "json",
                success: function(data) {
                    ...
                    if (!data.items || data.items.length === 0) {
                        ...
                        <div class="text-center">
                            <img src="<?php echo $base_url; ?>images/cart.png" alt="Empty Cart" class="img-fluid" style="max-width: 150px;">
                    ...
                    data.items.forEach(item => {
                        ...
                        <div class="cart-item d-flex align-items-center mb-3" id="cart-item-${item.id}">
                            <img src="<?php echo $base_url; ?>${item.image}" alt="${item.name}" class="cart-item-img rounded">
        ...
        $(document).ready(function() {
            ...
            $(document).on("click", ".remove-item", function() {
                ...
                $.ajax({
                    url: "<?php echo $base_url; ?>server/remove_from_cart.php",
                    method: "POST",
                    data: {
            ...
            $("#confirmLogoutBtn").on("click", function() {
                window.location.href = "<?php echo $base_url; ?>server/logout.php";
            });
            ...
            <?php if (isset($_SESSION["user_id"]) && ($user_type === 'user' || $user_type === '')): ?>
                setInterval(function() {
                    $.ajax({
                        url: "<?php echo $base_url; ?>server/check_user_active.php",
                        method: "POST",
                        data: {
